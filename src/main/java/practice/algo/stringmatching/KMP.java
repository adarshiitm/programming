 ...
 */
public class KMP {
    public static Collection<Integer> getMatches(String s, String pattern) {
    ...
    private static Integer[] computePrefixFunction(String pattern) {
    ...
    public static void main(String[] args) {
        ...
        String p = "ABABCABAB";
        System.out.println(StringUtils.join(getMatches(s, p), ','));
    }
}
